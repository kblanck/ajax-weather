    ...
    (data) => {
      ...
      if (temp <= 10) {
        $modalContentDiv.append('<img id="onesie" src="./imgs/onesie.png">').append(`Oh my God, it feels like ${temp}° outside. Stay inside and maybe wear this onesie.`)
          ...
          { if (data.weather[0].main === 'Rain') {
            $modalContentDiv.append('<img id="raincoat" src="./imgs/raincoat.png">').append(`${temp}° doesn't make for a super cold day, but break out that raincoat. It's coming down!`);
            }
          }
          ...
          { if (data.weather[0].main === 'Rain') {
            $modalContentDiv.append('<img id="raincoat" src="./imgs/raincoat.png">').append(`At ${temp}°, it's not cold out there, but make sure you don that raincoat today. It's coming down!`);
            }
          }
